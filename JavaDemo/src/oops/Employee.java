...
public class Employee {
	...
	public static void main(String[] args) {
		...
		obj.setData(1, "Ishwar Zirpe", "Manager", "Developer", "Pune", "ishwar@gmail.com", 7385498062l, 100, true);
		obj.display();
		Employee obj1 = new Employee();
		obj1.setData(2, "Prashant Kalokhe", "Developer", "HR", "Pune", "prashantkalokhe@23", 1234567856l, 25, true);
